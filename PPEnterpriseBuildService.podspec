#
#  Be sure to run `pod spec lint PPEnterpriseBuildService.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Petr Pavlik" => "pavlipe7@gmail.com" }
  # s.authors          = { "Petr Pavlik" => "pavlipe7@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'Petr Pavlik', 'other author'
   s.social_media_url = 'http://twitter.com/ptrpavlik'
  ...
  s.source       = { :git => 'https://github.com/petrpavlik/PPEnterpriseBuildService.git', :tag => 'v0.0.2' }
